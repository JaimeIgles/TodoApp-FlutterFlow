  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      final user = await authManager.signInWithEmail(
        ...
        _model.logiPasswordTextController.text,
      );
      if (user == null) {
        return;
      }

      context.pushNamedAuth(OnboardingWidget.routeName, context.mounted);
    });
    ...
    _model.logiPasswordTextController ??= TextEditingController();
    _model.logiPasswordFocusNode ??= FocusNode();
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.asset(
                                  'assets/images/Screenshot_2026-02-10_at_12.46.27_AM.png',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: 'imageTag',
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.logiPasswordTextController,
                                        focusNode: _model.logiPasswordFocusNode,
                                        autofocus: false,
                                        enabled: true,
                                        textInputAction: TextInputAction.done,
                                        obscureText:
                                            !_model.logiPasswordVisibility,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                        ...
                                        enableInteractiveSelection: true,
                                        validator: _model
                                            .logiPasswordTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ].divide(SizedBox(height: 12.0)),
